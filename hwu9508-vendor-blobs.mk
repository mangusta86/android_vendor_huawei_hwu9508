...
PATH_FILES := vendor/huawei/hwu9508/proprietary
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/lib/hw/audio_policy.default.so:system/lib/hw/audio_policy.hwu9508.so \
    ...
    $(PATH_FILES)/lib/hw/lights.default.so:system/lib/hw/lights.hwu9508.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/vendor/lib/libbt-vendor.so:system/lib/libbt-vendor.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/vendor/firmware/fw_bcmdhd.bin:system/vendor/firmware/fw_bcmdhd.bin \
    $(PATH_FILES)/vendor/firmware/fw_bcmdhd_apsta.bin:system/vendor/firmware/fw_bcmdhd_apsta.bin \
    $(PATH_FILES)/vendor/firmware/fw_bcmdhd_p2p.bin:system/vendor/firmware/fw_bcmdhd_p2p.bin \
    $(PATH_FILES)/vendor/firmware/fw_bcmdhd_test.bin:system/vendor/firmware/fw_bcmdhd_test.bin \
    $(PATH_FILES)/vendor/firmware/nvram.txt:system/vendor/firmware/nvram.txt \
